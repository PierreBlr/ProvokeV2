...
// Returns the private 'App\Repository\MainCategorieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MainCategorieRepository.php';

return $this->privates['App\Repository\MainCategorieRepository'] = new \App\Repository\MainCategorieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
